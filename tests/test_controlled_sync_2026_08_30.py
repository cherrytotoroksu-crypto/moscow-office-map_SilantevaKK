...
class TestControlledSync20260830(unittest.TestCase):
    ...
    KNOWN_PREEXISTING_DUPLICATE_IDS = {"badaevsky", "pole", "proj-274", "proj-129", "proj-112", "proj-261", "proj-134", "proj-244", "proj-180", "proj-194", "proj-245", "proj-150", "proj-258", "proj-189"}
