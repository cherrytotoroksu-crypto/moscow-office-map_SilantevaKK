    ...
    def test_confirmed_duplicates_are_not_in_active_layer(self):
        ...
        self.assertEqual(
            duplicate_ids,
            {
                ...
                # OBJ-0339 "Север.Сити" = OBJ-0374 "Aurus" (идентичные адрес/
                # застройщик/GBA=393264 — разрешает давнюю неоднозначность
                # именования из classifier-аудита)
                "OBJ-0233", "OBJ-0270", "OBJ-0339",
            },
        )
