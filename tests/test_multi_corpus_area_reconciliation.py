...
KNOWN_MULTI_CORPUS_PROJECTS = [
    ...
    ("proj-112", "gba", 141728, 0),  # Air, 2 корпуса (20/28 эт., реальная структура продаж tekta.ru); разделено пропорционально этажности, оценка
    ("proj-261", "gba", 130873, 0),  # Set, 2 башни; разделено пропорционально этажности (20/38), оценка
    ("proj-134", "gla", 22000 + 60000, 0),  # JOIS CREDO/MAST — реальная GLA по башням (сайт застройщика), GBA раскладка пропорциональна ей
    ("proj-244", "gba", 73355 + 32000, 0),  # Рублево Бизнес-Парк — башня В подтверждена напрямую (32000, продаётся целиком), А — остаток
    ("proj-180", "gba", 24000 + 21000 + 24300, 0),  # STONE Калужская K1/K2/K3 — реальные подтверждённые GBA с сайта застройщика (не пропорция); сумма 69300 меньше прежней проектной GBA=83000, расхождение задокументировано в qa_notes
    ...
    ("proj-245", "gba", 58800 + 26200, 30),  # Сити-4 — реальные GBA по блокам А/Б (wewall.ru), сумма 85000 vs прежней проектной 84972, погрешность округления
    ("proj-150", "gba", 74679, 0),  # Link RUNE/NEO, этажность неизвестна — пропорционально высоте (120м/53м)
    ("proj-258", "gba", 160000, 0),  # STONE SKY Ходынка (бывш. STONE Ходынка IV), F1/F2 пропорционально этажности (52/16); внимание — GBA реестра расходится с новой офиц. цифрой 136000, см. qa_notes
    ("proj-189", "gba", 98400, 0),  # STONE Мневники III, 2 башни (27/17 этажей) пропорционально этажности
]
