...
REMAIN_RECORDS = [
    ...
    {"external_name": "ЗИЛАРТ GRAND (Дом 18)", "category": "only_remain", "developer": "ЛСР", "completion": "2026-Q2", "gba": 35600, "office_area": 18950, "confidence": "medium", "note": "лоты подтверждены на lsr.ru, остаётся internal_only до NF-подтверждения. FLAGGED 2026-08-19: future_projects.json OBJ-0640 имеет то же имя/девелопера, но GBA 187706 (жилая башня целиком) почти в 5 раз больше — вероятно другое здание того же квартала, НЕ объединено (недостаточно доказательств), см. qa_notes remain-only-0002 в data/."},
