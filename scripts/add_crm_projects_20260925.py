...
OBJECTS = [
    ...
    },
    {
        ...
        "source_links": ["https://novostroy-m.ru/", "https://of.ru/", "https://rusdevelopers.ru/"],
        "confidence": "low",
        "verification_status": "Объект подтверждён несколькими агрегаторами; срок и статус расходятся, добавлено из CRM-выгрузки 25.09.2026.",
        "classification_note": "БЦ 18 этажей, 41 000 м² (общая площадь, GLA не найдена), класс A (of.ru называет Prime). Срок ввода расходится: novostroy-m и of.ru — построен в 2025, rusdevelopers — строится, ввод IV кв. 2027; CRM — 2024. Статус «введён» принят по двум источникам (novostroy-m, of.ru), год не выбран.",
        "review_reason": "Конфликт источников по статусу и сроку ввода.",
    },
    {
