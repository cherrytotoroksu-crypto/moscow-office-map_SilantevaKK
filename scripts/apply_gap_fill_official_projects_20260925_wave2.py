"""Apply the second reviewed wave of current commissioning plans."""
...
QA_PATH = ROOT / "data" / "qa" / "gap_fill_official_projects_20260925_wave2.json"
...
def main():
    ...
    if missing:
        raise ValueError(f"Second-wave targets not found: {missing}")

    date_keys = {
        "proj-91": "stone белорусская",
        "proj-99": "магистральная 12 (бывший — магистральная ул., 12)",
    }
