"""Apply the seventh reviewed wave of office-project lifecycle dates."""
...
QA_PATH = ROOT / "data" / "qa" / "gap_fill_official_projects_20260926_wave7.json"
...
def main():
    ...
    for row in rows:
        ...
        source_parts.append("Verified official sources: " + ", ".join(item["sources"]))
    ...
    if missing:
        raise ValueError(f"Seventh-wave targets not found: {missing}")
