"""Apply the sixth reviewed wave of office-project dates and corrections."""
...
QA_PATH = ROOT / "data" / "qa" / "gap_fill_official_projects_20260926_wave6.json"
...
def main():
    ...
    for row in rows:
        ...
        classifier_row["classification_note"] = item.get(
            "classifier_classification_note", item["decision"]
        )
    ...
    if missing:
        raise ValueError(f"Sixth-wave targets not found: {missing}")
