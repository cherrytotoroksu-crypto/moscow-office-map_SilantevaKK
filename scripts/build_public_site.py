...
DATA_ALLOW_PATTERNS = [
    ...
    # Слой «Все офисные проекты — свод» (index.html). Публикуется наравне с
    # продажей/арендой/коворкингами по прямому решению пользователя 2026-08-05.
    # В отличие от all_projects_layer.json поля public_visibility здесь нет —
    ...
    # Вкладка "БЦ 2ГИС" в codifier.html (добавлена 2026-09-23) — без паттерна
